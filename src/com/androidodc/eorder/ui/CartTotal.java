...
public class CartTotal extends Activity implements OnClickListener {
    ...
    private void initData(){
        //TODO init data here 
//        mCategory = new DishCategory();
        mDishList[0] = new DishDetail(R.drawable.icon, "cold1",29,1);
        mDishList[1] = new DishDetail(R.drawable.icon, "cold2",23,1);
        mDishList[2] = new DishDetail(R.drawable.icon, "cold3",19,1);
        mDishList[3] = new DishDetail(R.drawable.icon, "cold4",17,1);
        mDishList[4] = new DishDetail(R.drawable.icon, "cold5",13,1);
    }
    private void initUI() {
